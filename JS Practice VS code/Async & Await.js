...
//another example for async & await with promises

     function fetchData(url) {
        return new Promise(async (resolve, reject) => {
            const respo = await fetch(url); // Await the fetch promise
        if (!respo.ok) {
            reject(`HTTP error! Status: ${respo.status}`);
        } else {
    ...
    const apiURLl = 'https://jsonplaceholder.typicode.com/posts'; // Example API URL ( valid api-https://jsonplaceholder.typicode.com/posts)
